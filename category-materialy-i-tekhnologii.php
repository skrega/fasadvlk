...
<div class="posts section">
    <div class="container">
        ...
        <div class="tabs-block">
            ...
            $args = array(
                'post_type' => 'post',
                'cat' => '239,244,242,6', // ID категорий, разделенных запятой
            );
                ...
                if ($posts->have_posts()) {
                    while ($posts->have_posts()) {
                        ...
                        if ($thumbnail == '') {
                            ...
                            $img = 'style="background-image: linear-gradient(0deg, rgba(2, 13, 38, 0.60) 0%, rgba(2, 13, 38, 0.60) 100%), url(' . $thumbnail . ')"';
                        }
                ?>

                        <div class="post-item mix all <?php foreach ($categories as $cat) {
                                                            echo $cat->slug . ' ';
                                                        } ?>">
